class_name CapiangoStateMachine
extends Node

@export var character : CharacterBody2D
@export var current_state : CapiangoState
@export var anim_tree : AnimationTree

var states : Array[CapiangoState]

func _ready():
	for child in get_children():
		if child is CapiangoState:
			states.append(child)
...
func switch_state(new_state : CapiangoState):
...
func on_state_interrupt_state(new_state : CapiangoState):
